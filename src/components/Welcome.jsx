...
const setTextHover = (container, type) => {
    ...
    const letters = container.querySelectorAll('span');//Target the span becuase each span is acutally a letter
    ...
    const handleMouseLeave = () => {
        letters.forEach((letter) => animateLetter(letter, 0.3))
    }
        ...
        <section id='welcome'>
            ...
            <h1 ref={titleRef} className='mt-7'>
                {renderText("portfolio", 'text-9xl italic font-georama')} < /h1>
                    ...
                    This is portfolio is designed for tablets/desktops only.
                    </div>
                    </section>
                    )
                }
